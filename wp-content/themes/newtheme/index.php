...
?>
            <div class="home-section fullwidth-slider-fade bg-dark" id="home">
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-50" data-background="<?php echo get_template_directory_uri();
?>/assets/images/full-width-images/section-bg-18.jpg">
                ...
                <!-- End Slide Item -->
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-30" data-background="<?php echo get_template_directory_uri();
?>/assets/images/full-width-images/section-bg-20.jpg">
                    <div class="js-height-full container">
                        <!-- Hero Content -->
                        <div class="home-content">
                            <div class="home-text">
                ...
                <!-- End Slide Item -->
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-30" data-background="<?php echo get_template_directory_uri();?>/assets/images/full-width-images/section-bg-19.jpg">
                    <div class="js-height-full container">
                        <!-- Hero Content -->
                        <div class="home-content">
                            <div class="home-text">
            ...
            <!-- Call Action Section -->
            <section class="page-section pt-0 pb-0 banner-section bg-dark" data-background="<?php echo get_template_directory_uri();
?>/assets/images/full-width-images/section-bg-20.jpg">
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <ul class="works-grid work-grid-3 work-grid-gut clearfix font-alt hover-white hide-titles" id="work-grid">
                        ...
                        <li class="work-item">
                            <a href="portfolio-single-1.html" class="work-ext-link">
                                <div class="work-img">
                                    <img class="work-img" src="<?php echo get_template_directory_uri();
?>/assets/images/portfolio/projects-13.jpg" alt="Work" />
                                </div>
                        ...
                        <li class="work-item">
                            <a href="portfolio-single-1.html" class="work-ext-link">
                                <div class="work-img">
                                    <img class="work-img" src="<?php echo get_template_directory_uri();
?>/assets/images/portfolio/projects-14.jpg" alt="Work" />
                                </div>
                                <div class="work-intro">
                        ...
                        <li class="work-item">
                            <a href="portfolio-single-1.html" class="work-ext-link">
                                <div class="work-img">
                                    <img class="work-img" src="<?php echo get_template_directory_uri();
?>/assets/images/portfolio/projects-6.jpg" alt="Work" />
                                </div>
                                <div class="work-intro">
            ...
            <section class="page-section bg-dark bg-dark-alfa-90 fullwidth-slider" data-background="<?php echo get_template_directory_uri();
?>/assets/images/full-width-images/section-bg-20.jpg">
                <!-- Slide Item -->
                <div>
                    <div class="container relative">
                    ...
                    <div class="row multi-columns-row">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.1s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/shop/shop-prev-1.jpg" alt="" /></a>
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/shop/shop-prev-2.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/shop/shop-prev-3.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.4s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/shop/shop-prev-4.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-7 mb-sm-40">
                            ...
                            <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                                <ul class="clearlist work-full-slider owl-carousel">
                                    <li>
                                        <img src="<?php echo get_template_directory_uri();
?>/assets/images/promo-3.png" alt="" />
                                    </li>
                                    <li>
                                        <img src="<?php echo get_template_directory_uri();
?>/assets/images/portfolio/full-project-2.jpg" alt="" />
                                    </li>
                                </ul>
                            </div>
                            <!-- End Gallery -->
                        ...
                        <div class="col-md-7 col-lg-offset-1">
                            ...
                            <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                                <ul class="clearlist work-full-slider owl-carousel">
                                    <li>
                                        <img src="<?php echo get_template_directory_uri();
?>/assets/images/promo-4.png" alt="" />
                                    </li>
                                    <li>
                                        <img src="<?php echo get_template_directory_uri();
?>/assets/images/portfolio/full-project-4.jpg" alt="" />
                                    </li>
                                </ul>
                            </div>
                            <!-- End Work Gallery -->
            ...
            <!-- End Section -->
            <!-- Section -->
            <section class="page-section bg-dark-alfa-70 bg-scroll" data-background="<?php echo get_template_directory_uri();
?>/assets/images/full-width-images/section-bg-20.jpg">
                <div class="container relative">
                    <!-- Features Grid -->
                ...
                <div class="container relative">
                    ...
                    <div class="row multi-columns-row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.1s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/blog/post-prev-1.jpg" alt="" /></a>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/blog/post-prev-2.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="<?php echo get_template_directory_uri();
?>/assets/images/blog/post-prev-3.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt">
